	...
	*/
	...
	public void Application_Should_SatisfyProblemExample_When_Queried() throws Exception {
		final var points = Arrays.asList(
			this.toJSON("{'payer': 'DANNON', 'points': 300, 'date': ''}"),
			this.toJSON("{'payer': 'UNILEVER', 'points': 200, 'date': ''}"),
			this.toJSON("{'payer': 'DANNON', 'points': -200, 'date': ''}"),
			this.toJSON("{'payer': 'MILLER COORS', 'points': 10000, 'date': ''}"),
			this.toJSON("{'payer': 'DANNON', 'points': 1000, 'date': ''}")
		);
	...
	*/
	...
	public void PostPoints_Should_ReturnHTTP400_When_RequestBodyIsInvalid() throws Exception {
		...
		var invalidRequestBodies = Arrays.asList(
			...
			this.toJSON("{'payer': 'bob', 'points': 100, 'date': '2021-01-01'}"),
